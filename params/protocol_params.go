...
const (
	...
	FalconHashToPointGas uint64 = 1000 // Falcon hash-to-point precompile gas price (stub)
	FalconCoreGas        uint64 = 2000 // Falcon core verification precompile gas price (stub)
	...
	MaxFrames int = 1000 // Maximum number of frames per frame transaction.
)
